...
function AirPollution(){
    ...
    if (
        ...
        return (
        <Skeleton className="h-[12rem] w-full col-span-2 ms:col-span-full"/>
    );
}
...
const filteredIndex = airQualityIndexText.find((item) => {
    ...
    return <div className="air-pollution col-span-full sm-2:col-span-2 pt-6 px-4 h-[12rem] border rounded-lg flex
