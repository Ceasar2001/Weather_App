...
function SearchDialog(){
    ...
    const [hoveredIndex, setHoverIndex] = React.useState<number>(0);
                ...
                <ul className="px-3 pb-2">
                    ...
                    {geoCodedList && geoCodedList.map((
                       ...
                       lon: number;
                        ...
                        return <li key={index}
                        className={`py-3 px-2 text-sm rounded-md cursor-default hover:bg-accent 
                        ${hoveredIndex === index ? "bg-accent" : "none"}
                        `} 
